...
module spi_master(
	 ...
	 input logic [17:0] words_to_read,
	...
	logic [17:0] counter_send; //64 max
	logic [2:0] state;
	logic [23:0] read_addr_reg;
	logic [7:0] wr_data_reg;
	logic [7:0] read_cmd;
	logic [7:0] write_cmd;
	logic [7:0] write_en_cmd;
	logic [7:0] cmd;
	logic spi_ss_reg;
	logic read_req_r;
	logic [17:0] words_to_read_reg;
	logic [17:0] words_to_read_reg_sub0, words_to_read_reg_sub1;

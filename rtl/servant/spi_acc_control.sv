module spi_acc_control #(parameter DOUBLE_CLOCK = 0) (
    ...
    input  logic i_if_start,
    output logic o_if_load1,
    output logic o_if_load2,
    output logic o_if_snn_we,
    output logic o_if_set0,
    output logic o_if_clr,

    input  logic i_spi_valid,
    input  logic i_spi_end,
    output logic o_spi_en,
    output logic o_spi_read_ack
    );

    logic [4:0] out;
    logic     if_load1_ff,    if_load2_ff,    if_snn_we_ff,   if_set0_ff, if_clr_ff;
    logic    if_load1,       if_load2,       if_snn_we,      if_set0,    if_clr;

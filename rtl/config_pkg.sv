package config_pkg;
        ...
        parameter int INPUT_SPIKE_1 = 32;
        parameter int NEURON_1 = 64;
        parameter int NEURON_2 = 128;
        parameter int NEURON_3 = 64;
        parameter int NEURON_4 = 16;
        parameter int CURRENT_DECAY_1 = 4096-4096;
